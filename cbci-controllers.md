...
```bsh
echo https://amcdermott-cb.workshop.cb-sa.io/cjoc/
```
...
curl --user "admin:$CJOC_ADMIN_API_TOKEN" -XPOST \
              https://amcdermott-cb.workshop.cb-sa.io/cjoc/casc-items/create-items \
...
gcloud container clusters delete amcdermott-cb --region=us-east1 --async
